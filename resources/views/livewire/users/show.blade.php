    <div class="profile-page">
        <div class="content">
            ...
            <div class="content__title">
                <label for="profile-pic" style="padding: 0.5rem; border-radius: 0.5rem;"><span class="btn btn-primary" style="padding: 0.5rem;border-radius: 10px ;border-radius: 0.5rem" ><i class="uil uil-user-circle"> Change Profile</i></span></label>
                <button wire:click='save' class="btn btn-primary"
                    style="padding: 0.5rem;border-radius: 10px ;background: rgb(132, 255, 0);border-radius: 0.5rem;color: black"><span><i class="uil uil-save">Save</i></span></button>
                @error('pic')
            ...
            <ul class="content__list">
                ...
                <li><span>{{ $user->detail->meme_likes }}</span>Liked Meme</li>
            </ul>
        </div>
        <div class="bg">
            <div>
